...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('stylehome/assets/img/favicons/apple-touch-icon.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('stylehome/assets/img/favicons/favicon-32x32.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('style/assets/images/adem.png') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('stylehome/assets/img/favicons/favicon.ico') }}">
    <link rel="manifest" href="{{ asset('stylehome/assets/img/favicons/manifest.json') }}">
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link rel="preconnect" href="{{ asset('stylehome/https://fonts.gstatic.com') }}">
    <link href="{{ asset('stylehome/https://fonts.googleapis.com/css2?family=Manrope:wght@200;300;400;500;600;700&amp;display=swap') }}" rel="stylesheet">
    <link href="{{ asset('stylehome/vendors/prism/prism.css') }}" rel="stylesheet">
    <link href="{{ asset('stylehome/vendors/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
    <link href="{{ asset('stylehome/assets/css/theme.css') }}" rel="stylesheet" />
    <link href="{{ asset('stylehome/assets/css/user.css') }}" rel="stylesheet" />
  ...
  <body>
    ...
    <main class="main" id="top">
     @extends('layouts.topbar')
      <div class="bg-dark"><img class="img-fluid position-absolute end-0" src="{{ asset('stylehome/assets/img/hero/hero-bg.png') }}" alt="" />
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="{{ asset('stylehome/vendors/popper/popper.min.js') }}"></script>
    <script src="{{ asset('stylehome/vendors/bootstrap/bootstrap.min.js') }}"></script>
    <script src="{{ asset('stylehome/vendors/anchorjs/anchor.min.js') }}"></script>
    <script src="{{ asset('stylehome/vendors/is/is.min.js') }}"></script>
    <script src="{{ asset('stylehome/vendors/fontawesome/all.min.js') }}"></script>
    <script src="{{ asset('stylehome/vendors/lodash/lodash.min.js') }}"></script>
    <script src="{{ asset('stylehome/https://polyfill.io/v3/polyfill.min.js?features=window.scroll') }}"></script>
    <script src="{{ asset('stylehome/vendors/prism/prism.js') }}"></script>
    <script src="{{ asset('stylehome/vendors/swiper/swiper-bundle.min.js') }}"></script>
    <script src="{{ asset('stylehome/assets/js/theme.js') }}"></script>
